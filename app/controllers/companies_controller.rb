class CompaniesController < ApplicationController
  ...
  def show
    ...
    if params[:search].present?
      # @complaints = Complaint.where("name like ? or description like ?", "%#{params[:filtro]}%", "%#{params[:filtro]}%")
      # render ":)"
      @complaints = @complaints.select{|complaint| complaint.user.email == params[:search]}
    end
